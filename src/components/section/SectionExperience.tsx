...
export const SectionExperience = () => {
  ...
  return (
    <>
      <div className="padding-x container-max-width py-5">
        <h2 className="subtitle-portfolio mb-6">Experiencia</h2>
        <section className="grid gap-y-8 py-5 sm:gap-x-8 min-[740px]:grid-cols-[.8fr,1fr] min-[740px]:gap-x-12 min-[740px]:gap-y-0 lg:grid-cols-[.7fr,1fr] lg:gap-x-14 min-[1140px]:grid-cols-2 min-[1350px]:grid-cols-[1fr,.9fr]">
          <div>
            <TechnologyInfo
              date={date}
              role={role}
