  ...
  return (
    <>
      <motion.div
        ...
        className="padding-x container-max-width grid grid-cols-1 grid-rows-[170px,_1fr] gap-y-12 py-9 pt-12 sm:grid-rows-none sm:gap-y-8 sm:py-12 sm:pt-16 lg:grid-cols-2 lg:gap-x-9 lg:gap-y-0 lg:pt-24 min-[1750px]:grid-cols-hero-grid-max"
      >
