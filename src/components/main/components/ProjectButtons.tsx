    ...
    <>
      <div className="mt-8 grid grid-cols-[repeat(2,max-content)] gap-x-3 gap-y-4 min-[550px]:grid-cols-[repeat(2,max-content)] sm:gap-x-3 min-[740px]:mt-3 lg:mt-6 lg:gap-x-4 lg:gap-y-0">
        <Link
          href={url_github}
          target="_blank"
          className="social-network grid grid-cols-[22px,max-content] items-center  gap-x-3 lg:hover:bg-[#232326]"
        >
        ...
        <Link
          href={url_website}
          target="_blank"
          className="social-network grid grid-cols-[23px,1fr] items-center gap-x-2  py-[10px] text-[15px] font-normal text-white lg:hover:bg-[#232326]"
        >
